...
class signinPartenaire_view {
  ...
  public function signinPartenaire() {
    ?>  
    <div class="min-h-screen flex items-center justify-center bg-gray-100">
        <div class="flex flex-col-reverse md:flex-row bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl">
            ...
            <div class="w-full md:w-1/2 p-6 sm:p-12">
                ...
                ?>
                <form class="mt-4 space-y-4" id="signinPartenaire" action="./signinPartenaire.php" method="post">
                    <!-- Username -->
                    <div>
    ...
    public function display_signinPartenaire_view(){
        $instance = new signinPartenaire_view();
        $instance->head_description();
        $instance->signinPartenaire();
    }
}