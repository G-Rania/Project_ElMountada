...
class signinUser_view {
  ...
  public function signinUser() {
    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-100">
        <div class="flex flex-col-reverse md:flex-row bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl">
            ...
            <div class="w-full md:w-1/2 p-6 sm:p-12">
                ...
                ?>
                <form class="mt-4 space-y-4" id="signinUser" action="./signinUser.php" method="post">
                    <!-- Username -->
                    <div>
                ...
                <div class="mt-4 text-center">
                    <a href="./signupUser.php" class="text-sm text-teal-600 hover:underline">Créer un nouveau compte</a>
                </div>
            </div>
        </div>
    </div>
    ...
    public function display_signinUser_view(){
        $instance = new signinUser_view();
